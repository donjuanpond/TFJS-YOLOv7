...
export function non_max_suppression(res, conf_thresh=0.30, iou_thresh=0.2, max_det = 300){
    ...
    for (let i = 0; i < res.length; i++) {
        ...
        all_nums = all_nums + String(res[i][4]) + " "
    ...
    console.log("all classification scores:"+all_nums)
